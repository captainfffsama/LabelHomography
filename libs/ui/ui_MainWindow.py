...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionOpenDir.setIcon(icon)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icon/icon/previous.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionPreviousSample.setIcon(icon1)
        self.actionPreviousSample.setObjectName("actionPreviousSample")
        self.actionNextSample = QtWidgets.QAction(MainWindow)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icon/icon/next.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionNextSample.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icon/icon/add-new.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAddShape.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icon/icon/save.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
